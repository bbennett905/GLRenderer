...
{
	Profiling::ProfileSample drawRoot("BaseDraw::Draw");
	{
		Profiling::ProfileSample drawUseShad("BaseDraw::Draw::ShaderObj->Use()");
		ShaderObj->Use();
	}
	...
	{
		Profiling::ProfileSample drawDraw("BaseDraw::Draw::DrawArrays/Elements");
